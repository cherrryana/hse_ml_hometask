...
- Я добавила флаг`handle_unknown='ignore'` в OHE (чтобы фичи совпадали ежду тем, на чем был обучена модель и тем, что подается ей на вход) - это может давать нулевые векторы для новых семплов
